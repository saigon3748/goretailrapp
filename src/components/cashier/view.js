              ...
              <View style={{
                ...
                {this.state.menu.map(menuItem => {
                  if (menuItem.image) {
                    ...
                    return (
                      <TouchableOpacity key={menuItem._id} activeOpacity={1.0} onPress={() => this.onAddItem(menuItem._id)}>
                        <View style={{width: 150, height: 150, marginTop: 10, marginLeft: 10, backgroundColor: '#489378'}}>
                          <Text style={{backgroundColor: 'rgba(221, 226, 229, 0.8)'}}>
                            {menuItem.name}
                          </Text>
                          <Text style={{backgroundColor: 'rgba(221, 226, 229, 0.8)'}}>
                      ...
                      renderItem={({item, separators}) => (
                        <View style={{marginTop: 20}}>
                          ...
                          <View style={{flex: 1, flexDirection: 'row', marginTop: 10}}>
                            ...
                            <Button full small style={{backgroundColor: '#489378'}}><Text> E </Text></Button>
                            <View style={{flex: 1}}/>
            ...
            <ScrollView horizontal={true} style={{flex: 1, flexDirection: 'row'}}>
              {this.state.subs.map(category => (
                <View key={category._id} style={{width: 150, height: 60, marginTop: 10, marginLeft: 10}}>
                  <Button full large success onPress={() => this.onSelectCategory(category)} style={{backgroundColor: '#489378'}}><Text> {category.name} </Text></Button>
                </View>
              ))}
            </ScrollView>
          </View>   
